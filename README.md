...
I design systems that eliminate friction.
My focus is on automation, process design, and building tools that make complex workflows simple, fast, and scalable.

I think in systems. I build in public. I document everything.
...
focus      = ["Systems Design", "Process Automation", "API Integration"]
tools      = ["n8n", "GitHub", "VS Code"]
learning   = ["LangChain", "BPMN", "Health Informatics (HL7/FHIR)"]
```
